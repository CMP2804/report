...
Jay section---- 
Jay designed the freeform level section of the level which contains 5 rooms and obstacles for the player to navigate and avoid enemies. The freeform level went under 2 different designs, freeform level 1 and freeform level 2. Jay did not have much experience with level design and the freeform level 1 turned out rather big and clunky due to all the materials and separate structures Jay built and jig sawed together to make the level. However, by the time Jay designed the second freeform level which we are using in our release, Jay had a bit more experience and confidence and under the guide of Harper and our project leader, Stevie, Jay was able to create a much more flowing, smaller, tidier level with much fewer separate structures and sort out more to do the level as Jay learnt more. Jay used pro builder for the building of the freeform level. Pro builder allows you to quickly create and prototype 3D levels, as well as create basic 3D models without leaving Unity. Jay made freeform level 2 by first creating a flat poly shape, an outer layer to cover the area the level was going to be and then created another smaller floor area which was the actual size of the level, this was a plane. Then drew a rough estimate of the rooms and floor and all the corner points and then using one poly shape created one side of the level and using a second poly shape created the other side of the level. Jay then put in all objects that the player could navigate around and put enemies in each room and set patrol nodes, although Jay did run into a few problems and needed guidance from Stevie to help sort the patrol nodes.

Jack Section ---- Jack started on the distraction mechanic which involves the player character throwing a rock to draw the attention of the enemies around the level. The design for this mechanic took time to develop as the player controller and enemy controller had to be finished before implementation could begin. Once this was done, Jack began to develop the various scripts and prefabs needed for the distraction mechanic. This also took some time as Jack had to learn about interfaces to be able to create an optimal design that would allow various instances of the enemy to be distracted. Once the distraction mechanic had been implemented it was tested quickly by other members of the team and there were few bugs to be fixed. Jack then started work on the enemy state indicators that would appear above each enemies head. There are three states to the enemies (patrol, investigate, and chase) which can be displayed over their heads using Unity canvases. Nothing is displayed for patrol, a question mark for investigate, and an exclamation mark for chase. These symbols were created using paint and had to be made in a way that clashes with the point cloud shader so the information can be displayed easily to the player.
...
## Group engagement
The group was very engaged at the beginning of the project in the planning phase, but more sparsely engaged during development of the game. 

Communication between team members was the biggest issue, with a lack of showing what each member has completed, and a rush at deadlines for help from other members. The main culprits of this were differences in experience and time-commitment between team members. This also resulted in tasks being cancelled, reassigned, or completed to a low quality.

Individual members were able to communicate effectively together outside of the main group when assigned to work on the same task, which allowed more experienced team members to teach the lesser experienced various skills and tools, such as GitHub and Unity, allowing them to complete more difficult tasks by themselves later on in the project.

It is clear some members failed to engage with the project on any useful level, with others having to take over their work. Once we recognised this, we planned ahead on what tasks may not get completed by the assigned team member, and allowed time for others to complete them instead. This resulted in tasks being completed that might have been cancelled otherwise. 

In response to the group reflection from the interim report, we decided to hold less meetings as we found them unproductive, especially with the project already planned out, and converted the meetings we had to online sessions to show off progress. 

Using GitHub’s project system instead of creating an actions agreed list proved useful for team members to see what work they must complete by what time from one place, which resulted in less deadlines being missed and less tasks being misunderstood.

## Individual contribution and reflection

| Team Member | Contribution Percentage | Contributions                                                               | Individual performance reflection                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ----------- | ----------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Stevie      | 30                      | Player character.<br>Enemy character.<br>Distraction mechanic.<br>Enemy AI. | For my part of the project, I thought it went quite well when it came to project management, although my communication was often flawed.<br>I thought the development methodology was quite effective and that it was a good idea that we selected GitHub flow as our branching strategy.<br>However, I recognise at times that I may have taken too much work on board, especially when it came to reviewing pull requests, as a lot of the pull requests were not thoroughly reviewed, and some were approved or even merged without following the review process.<br>As for the coding segment of the work, I felt it was adequate, although there were numerous bugs with the implementations, such as the fact that distracted enemies are unable to spot the player and enter chase mode. |
| Ethan       | 30                      | Point cloud.<br>Clap mechanic.<br>Sound radius effect.                      | Working solely on the visuals for the game, I made sure to start all tasks assigned to me early on in development as to allow other team members to get an idea of how the complete game should look.<br>This also allowed me to respond to any feedback, which I received from Stevie. An example of this is the creation of the object highlight system, which allows you to change the colour of an object at any time, overriding the material’s colour.<br>I missed a deadline for the project when creating the sound radius effect, which is due to my misunderstanding as we decided to move the playtesting phase back, and I assumed that meant my deadline also. In the future I will make sure to clarify anything as important as deadlines with the team when unsure.             |
| Harper      | 17                      | Guided tutorial.<br>Doors.<br>Buttons.                                      | I feel that I have done well in the level design and have worked well together in the group. I admit there were issues with communication between myself and some other members of the team which did delay parts of the project. I believes that over all my teamwork was good as I attended all meetings and, with assistance when needed, made good contributions in the form of scripting level design and sound creation. There were some issues where I couldn't complete certain parts of the project, this was mainly due to conflictions with other modules assignments, however I shall endeavour to improve and complete these next time.                                                                                                                                            |
| Jack        | 12                      | Enemy state indicator.<br>Rock throw.                                       | My communication with the team could have been better as I rarely spoke to anyone other than Stevie. It did improve towards the end of the project but by then it was too late. A lot of the time I was given for tasks was used to get my head around Unity as it had been some time since I had used it in the way I had to for this project. However, in the end the work I had done worked as it needed to for what we were making.                                                                                                                                                                                                                                                                                                                                                         |
| Jay         | 11                      | Freeform tutorial.                                                          | The group project did not go off to the best start. I had a lot of problems communicating with the group in the beginning and lack of experience with using group materials such as GitHub and that led to difficulties. However, as the project progressed I felt like I improved my communication and work ethic and gained experience with using GitHub and level design and contributed more to the final project as more of a team player.                                                                                                                                                                                                                                                                                                                                                 |
| Ryan        | 0                       | Game over UI                                                                | I was tasked to create the threat indicators and the UI for it but was unable to complete/finish it on time, so it got passed on, as I wasn’t the strongest at coding it became difficult. It became difficult for me to pick up anymore tasks as most of them required coding. On top of this was my own personal health which got in the way which was not very professional of me as it got in the way and made it difficult for me. However, I did create the game over menu which had a simplistic design and implementation. For future reference, I should have involved myself more into the group project and let personal matters not affect the project.                                                                                                                             |

## Action plan
In order to improve the group’s performance, we’ve agreed on the following action plan:
